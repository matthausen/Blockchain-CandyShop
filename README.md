...
The application runs at [http://localhost:5000](http://localhost:5000).
...
1. Client (payer)
2. Client (payee)
3. Amount of Candycoins (balance)
4. Amount of candies (credit)
5. Timestamps
...
```js
{
    "client": "payer name",
    "client": "payee name",
    "Balance": "Amount of candy coins",
    "Credit": "Amount of candies",
